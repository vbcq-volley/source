        ...
        if (sessionMatches.length > 0) {
          ...
          if (pastAllerMatches.length > 0) {
            ...
            pastAllerMatches.forEach(match => {
              teamContent += `- [${match.team1.replace(/ /g, '-')}](${teamsDir}/${match.team1.replace(/ /g, '-')}) vs [${match.team2.replace(/ /g, '-')}](${teamsDir}/${match.team2.replace(/ /g, '-')}) [${match.homeLocation.replace(/ /g, '-')}] - ${match.homeDate}\n`;
            });
            teamContent += `\n`;
          }
          ...
          if (pastRetourMatches.length > 0) {
            ...
            pastRetourMatches.forEach(match => {
              teamContent += `- [${match.team2.replace(/ /g, '-')}](${teamsDir}/${match.team2.replace(/ /g, '-')}) vs [${match.team1.replace(/ /g, '-')}](${teamsDir}/${match.team1.replace(/ /g, '-')}) [${match.awayLocation.replace(/ /g, '-')}] - ${match.awayDate}\n`;
            });
            teamContent += `\n`;
          }
